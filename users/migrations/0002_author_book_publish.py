    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(help_text='作者', to='users.Author', verbose_name='作者')),
                ('publisher', models.ForeignKey(help_text='出版商', on_delete=django.db.models.deletion.CASCADE, to='users.Publish', verbose_name='出版社')),
            ],
            options={
                'verbose_name': '图书信息',
